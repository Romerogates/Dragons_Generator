...
export function buildFirstSessionChecklist(
  ...
  const steps: FirstSessionStepView[] = [
    ...
    },
    {
      ...
      hint: 'Planifiez une session ou entrez en jeu.',
      actionLabel: input.hasPlannedSession ? 'Sessions' : 'Planifier',
    ...
    },
    {
      ...
      hint: 'Ouvrez la table live pour jouer.',
      actionLabel: 'Ouvrir la table',
      action: 'openPlay',
    },
  ];
